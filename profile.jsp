<%-- 
    Document   : profile
    Created on : Sep 27, 2017, 6:06:59 PM
    Author     : DELL
--%>
  ...
  if (!event.target.matches('.dropbtn')) {
    ...
    <body style="background: #FAFAFA">
        <%
            ...
            ResultSet rs = st.executeQuery("select * from staff_r where uname='"+uname+"'");
        %>
            ...
            <div style="text-align: end; width: 1175px;">
                <div style="position: absolute; padding-top: 3px;" class="dropdown">
                    ...
                    <div id="myDropdown" class="dropdown-content" align="left">
                        <a href="profile.jsp?username=<%=uname %>">Profile</a>
        ...
        <div align="center">
            <a href="staff_page.jsp"><button style="font-size: 18px;">Back</button></a>
        </div>
    </body>
</html>
